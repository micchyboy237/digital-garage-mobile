...
function translate(key: string, interpolations?: Record<string, string>): string {
...
export const UserPodcastListScreen: FC<UserTabScreenProps<"UserPodcastList">> = observer(
  function UserPodcastListScreen(_props) {
    ...
    return (
      ...
      >
        <ListView<Episode>
          ...
          ListHeaderComponent={
            <View style={$heading}>
              <Text preset="heading">{translations.title}</Text>
    ...
    () =>
      Platform.select<AccessibilityProps>({
        ios: {
          ...
          accessibilityHint: translate(translations.accessibility.cardHint, {
      ...
      FooterComponent={
        ...
        >
          <Text
            ...
            accessibilityLabel={episode.duration.accessibilityLabel}
            weight="medium"
            text={isFavorite ? translations.favoriteButton : translations.unfavoriteButton}
          />
        </Button>
      }
    />
